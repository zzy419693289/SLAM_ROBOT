...
public:
    ...
    GlobalNavigating(double longitude_, double latitude_);
...
protected:  
    void Trans_HardMap(GPS_data* GPS_Ptr, double& Latitude, double& Longitude);

    bool HaveArrivedNode(double Now_Longitude, double Now_Latitude, double End_Longitude, double End_Latitude);	//judge whether the car is near end point

    float Calculate_angle(double Now_Longitude, double Now_Latitude, double End_Longitude, double End_Latitude);	//from 0-360, North is zero    
